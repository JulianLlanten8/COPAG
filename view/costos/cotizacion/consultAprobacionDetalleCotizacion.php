...
?>
    <div class="x_content">
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" readonly="readonly"class="btn btn-success btn-sm collapse-link">Descripcion
                ...
                <div class="x_content" style="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <textarea name="descripcion"readonly="readonly"  class="resizable_textarea form-control"
        ...
        <div class="col-md-12 col-sm-12">
                ...
                <div class="x_content">
                    <div class="col-md-6">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                    ...
                                    foreach($productoBase as $producto){
                                        if($producto['Pba_id']==$cdc['Pba_id']){
                                            ...
                                            echo "<input type='text' readonly='readonly' class='form-control' value='".$producto['Pba_descripcion']."'>";
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="number" readonly="readonly" name="cantidadProducto" id="detalleCotizacionCantidad" min="1"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="number" readonly="readonly" name="paginasProducto" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="number" readonly="readonly" name="tamanoAbierto" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="number" readonly="readonly" name="tamanoCerrado" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 "><strong>Costo
                                            diseño:</strong></label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="number" readonly="readonly" name="costoDiseno" id="totalDiseno" class="form-control"
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                            ...
                                            for($i=0;$i<count($encargadoDiseño);$i++){
                                                ...
                                                if($encargadoDiseño[$i]==$cdc['Dpe_encargadoDiseno']){
                                                    ...
                                                    echo "<input type='text' readonly='readonly' class='form-control' value='".$encargadoDiseño[$i]."'>";
                                                    $i=count($encargadoDiseño) + 2;
                                                }
                                                
                                            }
                                            if($i!=count($encargadoDiseño)+2){
                ...
                <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Cantidad:</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="number" readonly='readonly' name="cantidadPlancha"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="number" readonly='readonly' name="costoUnitarioPlancha"
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="number" readonly='readonly' name="valorTotalPlancha" class="form-control calcularResultado"
            ...
            <!-- Bloque de Tintas -->
            <?php
                include_once '../view/costos/cotizacion/Bloques/consulBloqueTinta.php';
            ?>


            <!-- Inicio Bloque material -->
            <?php
                include_once '../view/costos/cotizacion/Bloques/consultBloqueMaterial.php';
            ?>


            <!-- Inicio Bloque Terminados -->
            <?php
                include_once '../view/costos/cotizacion/Bloques/consultBloqueTerminados.php';
            ?>

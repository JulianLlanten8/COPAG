            ...
            <div class="x_content">
                ...
                <form id="formularioUsuario" action="<?php echo getUrl("PanelDeControl", "User", "postInsert") ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__primerNombreUsuario">
                        ...
                        <input type="text" id="Usu_primerNombre" class="form-control formularioPanel__input" name="Usu_primerNombre"/>
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__segundoNombreUsuario">
                        ...
                        <input type="text" id="Usu_segundoNombre" class="form-control formularioPanel__input" name="Usu_segundoNombre"/>
                        <p class="formularioPanel__input-error">Solo se permiten letras (a-z).</p>                    
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__primerApellidoUsuario">
                        ...
                        <input type="text" id="Usu_primerApellido" class="form-control formularioPanel__input" name="Usu_primerApellido"  />
                        <p class="formularioPanel__input-error">Solo se permiten letras (a-z).</p>                    
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__segundoApellidoUsuario">
                        ...
                        <input type="text" id="Usu_segundoApellido" class="form-control formularioPanel__input" name="Usu_segundoApellido"/>
                        <p class="formularioPanel__input-error">Solo se permiten letras (a-z).</p>                    
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__numeroDocumentoUsuario">
                        ...
                        <input type="number" id="Usu_numeroDocumento" class="form-control formularioPanel__input" name="Usu_numeroDocumento"  />
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__telefonoUsuario">
                        ...
                        <input type="number" id="Usu_telefono" class="form-control formularioPanel__input" name="Usu_telefono" />
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__emailUsuario">
                        ...
                        <input type="email" id="Usu_email" class="form-control formularioPanel__input" name="Usu_email"/>
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__rolUsuario">
                        ...
                        <select name="Rol_id" class="form-control formularioPanel__input" >
                            <option value="">Seleccione...</option>
                            <?php
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback" id="grupo__areaUsuario">
                        ...
                        <select name="Area_id" class="form-control formularioPanel__input" >
                            <option value="">Seleccione...</option>
                            <?php
